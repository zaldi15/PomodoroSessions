...
public class MenuController implements Initializable {
     ...
     */
    @FXML
    private void handleTracking(ActionEvent event) {
        if (currentUser == null) {
            showAlert(Alert.AlertType.ERROR, "Error", "User session tidak valid");
            return;
        }
        ...
        try {
            ...
            Stage stage = (Stage) btnTracking.getScene().getWindow();
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Error", "Gagal membuka Trcaking");
        }
    }
...
private void handleReport(ActionEvent event) {
    ...
    try {
        FXMLLoader loader =
            new FXMLLoader(getClass().getResource("/com/aplikasi/view/Report.fxml"));
        ...
        System.out.println("✔ Navigated to Report for user: "
 ...
 @FXML
    private void handleMissions(ActionEvent event) {
        if (currentUser == null) {
            showAlert(Alert.AlertType.ERROR, "Error", "User session tidak valid");
            return;
        }
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/aplikasi/view/MissionsView.fxml"));
            Parent root = loader.load();
            
            // Mengirim session user ke MissionsController
            MissionsController controller = loader.getController();
            controller.initForUser(currentUser); 

            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.getScene().setRoot(root);
            System.out.println("✔ Navigated to Missions");
        } catch (IOException e) {
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Error", "Gagal memuat MissionsView.fxml: " + e.getMessage());
        }
    }
